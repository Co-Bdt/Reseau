...
export function Fragment_90ccd54ece6ad48f79de229d55255b2e () {
  const reflex___state____state__reseau___common___base_state____base_state = useContext(StateContexts.reflex___state____state__reseau___common___base_state____base_state)
  const { resolvedColorMode } = useContext(ColorModeContext)
  const reflex___state____state = useContext(StateContexts.reflex___state____state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  const ref_search_term = useRef(null); refs['ref_search_term'] = ref_search_term;
  const reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state = useContext(StateContexts.reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state)


  
    const handleSubmit_ea282bdc58c4f437973eb6b4f4dd8877 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...{"search_term": getRefValue(refs['ref_search_term'])}}

        addEvents([Event("reflex___state____state.reseau___common___base_state____base_state.reseau___pages___members____members_state.search_city", {form_data:form_data})])
  ...
  <RadixThemesText as={`p`} css={{"@media screen and (min-width: 0)": {"marginInlineStart": "1em", "marginInlineEnd": "1em"}, "@media screen and (min-width: 30em)": {"marginInlineStart": "0", "marginInlineEnd": "0"}}}>
  {`Connecte avec d'autres gars aux mêmes valeurs que toi et progresse avec eux.`}
</RadixThemesText>
  <RadixFormRoot className={`Root `} css={{"width": "100%", "@media screen and (min-width: 0)": {"paddingInlineStart": "1em", "paddingInlineEnd": "1em"}, "@media screen and (min-width: 30em)": {"paddingInlineStart": "0", "paddingInlineEnd": "0"}}} onSubmit={handleSubmit_ea282bdc58c4f437973eb6b4f4dd8877}>
  <RadixThemesTextField.Root css={{"width": "100%"}} id={`search_term`} placeholder={`Recherche une ville`} ref={ref_search_term} size={`3`} variant={`surface`}/>
</RadixFormRoot>
  <Fragment>
  {isTrue(reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.users_displayed) ? (
  <Fragment>
  <RadixThemesBox css={{"width": "100%", "@media screen and (min-width: 0)": {"padding": "1em"}, "@media screen and (min-width: 30em)": {"padding": "0"}}}>
  <RadixThemesBox css={{"@media screen and (min-width: 0)": {"display": "none"}, "@media screen and (min-width: 30em)": {"display": "none"}, "@media screen and (min-width: 48em)": {"display": "none"}, "@media screen and (min-width: 62em)": {"display": "block"}}}>
  <RadixThemesGrid columns={`3`} css={{"width": "100%", "flexWrap": "wrap"}} gap={`3`}>
  {reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.users_displayed.map((user, index_908c9db6ea5356c3) => (
  <RadixThemesCard asChild={true} key={index_908c9db6ea5356c3} size={`3`}>
  <RadixThemesBox>
  ...
  {isTrue(user.at(1)) ? (
  <Fragment>
  <img css={{"width": "4.5vh", "height": "4.5vh", "border": "0.5px solid #ccc", "borderRadius": "50%"}} src={`${getBackendURL(env.UPLOAD)}/${user.at(0).id}_profile_picture.png`}/>
</Fragment>
) : (
  <Fragment>
  <img css={{"width": "4.5vh", "height": "4.5vh", "border": "0.5px solid #ccc", "borderRadius": "50%"}} src={`${getBackendURL(env.UPLOAD)}/blank_profile_picture.png`}/>
</Fragment>
)}
</Fragment>
  ...
  {`${user.at(2).name} (${user.at(2).postal_code})`}
</RadixThemesText>
</RadixThemesFlex>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} direction={`row`} gap={`1`}>
  {user.at(3).map((interest, index_4a408e4f0c91d88e) => (
  <RadixThemesBadge color={`amber`} key={index_4a408e4f0c91d88e} radius={`full`} variant={`surface`}>
  {interest.name}
</RadixThemesBadge>
))}
</RadixThemesFlex>
  ...
  <RadixThemesBox css={{"margin": "0.5em 0 0 0"}}>
  <Fragment>
  {isTrue(!user.at(0).profile_text) ? (
  <Fragment>
  <RadixThemesText as={`p`} color={`gray`} css={{"font-style": "italic"}} size={`2`}>
  {`Aucune description`}
</RadixThemesText>
</Fragment>
) : (
  <Fragment>
  <RadixThemesText as={`p`} css={{"line-height": "1.4", "letter-spacing": "0.2px"}} size={`2`}>
  {`${user.at(0).profile_text}`}
</RadixThemesText>
</Fragment>
)}
</Fragment>
  ...
  <RadixThemesGrid columns={`2`} css={{"width": "100%", "flexWrap": "wrap"}} gap={`3`}>
  {reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.users_displayed.map((user, index_908c9db6ea5356c3) => (
  <RadixThemesCard asChild={true} key={index_908c9db6ea5356c3} size={`3`}>
  <RadixThemesBox>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} direction={`column`} gap={`3`}>
  ...
  <RadixThemesBox css={{"@media screen and (min-width: 0)": {"display": "block"}, "@media screen and (min-width: 30em)": {"display": "none"}, "@media screen and (min-width: 48em)": {"display": "none"}, "@media screen and (min-width: 62em)": {"display": "none"}}}>
  <RadixThemesGrid columns={`1`} css={{"width": "100%", "flexWrap": "wrap"}} gap={`3`}>
  {reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.users_displayed.map((user, index_908c9db6ea5356c3) => (
  <RadixThemesCard asChild={true} key={index_908c9db6ea5356c3} size={`3`}>
  <RadixThemesBox>
  <RadixThemesFlex align={`start`} className={`rx-Stack`} direction={`column`} gap={`3`}>
  ...
  <Fragment>
  {isTrue(reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.city_searched) ? (
  <Fragment>
  <RadixThemesText align={`center`} as={`p`} css={{"width": "100%"}}>
  {`Aucune personne trouvée :                             ${reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.city_searched?.name}                             (${reflex___state____state__reseau___common___base_state____base_state__reseau___pages___members____members_state.city_searched?.postal_code})`}
</RadixThemesText>
</Fragment>
) : (
  <Fragment>
...
export default function Component() {
  ...
  <Fragment_90ccd54ece6ad48f79de229d55255b2e/>
