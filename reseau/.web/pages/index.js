...
export function Fragment_b34ea5a1a8f563c24bcdd749b604f8f8 () {
  const reflex___state____state__reseau___common___base_state____base_state = useContext(StateContexts.reflex___state____state__reseau___common___base_state____base_state)
  const { resolvedColorMode } = useContext(ColorModeContext)
  ...
  {reflex___state____state__reseau___common___base_state____base_state__reseau___pages___home____home_state.posts_displayed.map((post, index_1edb61bba2098d1f) => (
  <RadixThemesDialog.Root key={index_1edb61bba2098d1f}>
  ...
  <Fragment>
  <RadixThemesGrid columns={`1`} css={{"width": "100%"}} gap={`3`}>
  {reflex___state____state__reseau___common___base_state____base_state__reseau___pages___home____home_state.post_comments.map((comment, index_3a087c57fc97182e) => (
  <RadixThemesCard css={{"width": "100%", "backgroundColor": isTrue(((resolvedColorMode) === (`light`))) ? `#e9e9e9` : `#191918`, "@media screen and (min-width: 0)": {"padding": "1em 0.5em"}, "@media screen and (min-width: 30em)": {"padding": "1em"}}} key={index_3a087c57fc97182e}>
...
export default function Component() {
  ...
  <RadixThemesFlex align={`start`} className={`rx-Stack`} css={{"width": "100%"}} direction={`column`} gap={`3`}>
  <Fragment_b34ea5a1a8f563c24bcdd749b604f8f8/>
